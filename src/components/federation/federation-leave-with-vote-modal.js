...
const FederationLeaveWithVoteModal = ({ federation, platformId, modalOpen, closeModal, handleLeaveFederationWithVote }) => {
                ...
                <Fragment>
                    ...
                    <Modal.Footer>
                        <Button type="button" bsStyle="danger"
                                onClick={handleLeaveFederationWithVote}>Activate voting to remove the member</Button>
