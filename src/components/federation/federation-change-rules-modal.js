...
class FederationChangeRulesModal extends Component {
    ...
    onSubmit = (props) => {
      ...
      const bgovMembers = props.changeBoardGovId.map(
        ...
        const fedMarketplace   = new FedMarketplace(props.changeChargePolicyId,props.changeCoinId,props.changeFedProductId,props.changeProfitPolicyId,props.changeFedMarketChargeId,props.changeGlobalMarketChargeId);
    ...
    render() {
       ...
       // const smartContract = this.props.changeFederationRulesModal.federation.smartContract;
        ...
        return(
            <Modal show={modalOpen} onHide={this.close}  backdrop="static" keyboard={false} >
...
function validate(values) {
    ...
    const validationFunctions = {
        ...
        "changeFedMarketChargeId":isNotEmpty,
        "changeGlobalMarketChargeId":isNotEmpty
...
function mapStateToProps(state) {
   ...
   // console.log(state.changeFederationRulesModal.federationId);
    ...
    var  fedGovBoardGov  = state.changeFederationRulesModal.fedGovBoardGov;

     //in case the fedGovBoardGov is empty array
     if(fedGovBoardGov.length === 0){
        fedGovBoardGov=[""];
      }else{
    ...
    // const businessEnablement                            = QoEWeights.business_enablement;
     ...
     const  fedMarketplaceFedMarketPlaceCharge           = state.changeFederationRulesModal.fedMarketplace.FedMarketCharge;
     const  fedMarketplaceGlobalMarketPlaceCharge        = state.changeFederationRulesModal.fedMarketplace.GlobalMarketCharge;
