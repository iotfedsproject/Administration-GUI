...
const FederationChangeRulesFormBody = ({ federations, federation, isActive }) => {
    ...
    return (
        <Fragment>
                  <div className="qos-constraint">
                                 ...
                                 <FormGroup controlId="changeDataAvailabilityId" style={{zIndex: "5"}}>
                                    <ControlLabel>Products Visibility</ControlLabel>
                                     <Field
                                       ...
                                       placeholder="Select the products visibility"
                    ...
                    <Col lg={6} md={6} sm={6} xs={6}>
                     <FormGroup controlId="changeMinValueFedId" style={{zIndex: "5"}}>
                      {/*<ControlLabel>Min reputation value</ControlLabel>*/}
                       <Field
                        name="changeMinValueFedId"
                        label = "Min reputation value" type="text"
                        placeholder="Insert the minimum value of reputation"
                        component={renderInputField}
                     />
                    {/* <HelpBlock>Mandatory</HelpBlock>*/}
                    {/*<FieldError error={slaConstraints_comparator_error ? slaConstraints_comparator_error[index] : ""} />*/}
              ...
              <Row>
               <Col lg={6} md={6} sm={6} xs={6}>
                <FormGroup controlId="changeFedMarketChargeId" style={{zIndex: "5"}}>
                {/*<ControlLabel>Min Number of Federations</ControlLabel>*/}
                <Field
                 name="changeFedMarketChargeId"
              ...
              <Col lg={6} md={6} sm={6} xs={6}>
                <FormGroup controlId="changeGlobalMarketChargeId" style={{zIndex: "5"}}>
                {/*<ControlLabel>Min Number of Federations</ControlLabel>*/}
                <Field
                 name="changeGlobalMarketChargeId"
