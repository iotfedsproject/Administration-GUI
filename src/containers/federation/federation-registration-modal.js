...
class FederationRegistrationModal extends Component {
    ...
    onSubmit = (props) => {
        ...
        const federation = new Federation(id, name, isPublic, infoModel, slaConstraints, federationMembers,regRuleTypeId);
...
function validate(values) {
    ...
    const validationFunctions = {
        ...
        "regapprovalPercentId" : isNotEmpty,
        "regvoteRulesBaseId" : isNotEmpty,
        "regQosPercentageId" : isNotEmpty,
        "regreputationPercentId" : isNotEmpty,
