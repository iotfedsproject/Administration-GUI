...
class FederationRegistrationModal extends Component {
    ...
    onSubmit = (props) => {
        ...
        /////////////////////////////////////////////////
        var federationMembers = members.map(
        ...
        const fedMarketplace   = new FedMarketplace(props.regChargePolicyId,props.regCoinId,props.regFedProductId,props.regProfitPolicyId,props.regFedMarketChargeId,props.regGlobalMarketChargeId);
    ...
    render() {
        ...
        return(
            <Fragment>
                ...
                <Modal  show={modalState[FEDERATION_REGISTRATION_MODAL]} onHide={this.close} backdrop="static" keyboard={false}  >
...
function validate(values) {
    ...
    const validationFunctions = {
        ...
        "regFedMarketChargeId":isNotEmpty,
        "regGlobalMarketChargeId":isNotEmpty
